...
class HdmiCec:
	...
	def deepstandby(self):
		...
		if recording or rectimer or pwrtimer or scheduler:
			self.CECwritedebug(f"[HdmiCec] go not into deepstandby... recording={recording}, rectimer={rectimer}, pwrtimer={pwrtimer}, scheduler={scheduler}", True)
			self.standby()
		else:
