...
def getButtonSetupFunctions():
	...
	ButtonSetupFunctions.append((_("PowerTimer"), "Module/Screens.Timers/SchedulerOverview", textPower))
	...
	ButtonSetupFunctions.append((_("Mount Manager"), "Module/Screens.DeviceManager/DeviceManager", textSetup))
